<x-layout>
    ...
    <div class="container">
        ...
        <form id="createPartnerForm" action="/dashboard/partners/store" method="post" class="mx-auto w-3/5 mt-16 flex flex-col">
            @csrf
            ...
            @enderror
            <textarea name="description" id="description" cols="30" rows="10" class="w-full text-3xl text-thin placeholder-gray-300 placeholder-thin text-center !mb-12" placeholder="Description">{{old('desctription')}}</textarea>
