<x-layout>
    <div class="container">
        <h1>Image for this topic</h1>
        <h2 class="mb-20">Accepted files formats: jpg, png, svg, webp. Max filesize 2 MB.</h2>
        <form id="form" action="/dashboard/topics/{{$topic->hex}}/images/upload" method="POST" enctype="multipart/form-data" class="flex justify-center">
            @csrf
