<x-layout>
    ...
    <div class="container">
        <h1>Image for this testimonial</h1>
        <h2>Select the area of the image you want to use and click Crop image.</h2>

        <div class="flex gap-12">
            <div class="w-2/3 bg-yellow-500">
                <img id="image" src="{{$testimonial->getFullImage()}}" alt="" style="height:500px;" class="w-1/3">
            </div>

            <div class="w-1/3">
                <form action="{{url('dashboard/testimonials/'.$testimonial->hex.'/images/render')}}" method="POST" class="flex justify-between">
                    @csrf
                    ...
                    <div class="flex flex-col justify-between">
                        ...
                        <div>
                            <a href="/dashboard/testimonials/{{$testimonial->hex}}/images/upload">
